...
public class App { 
    ...
    static String telefonoBarberia = "7603-1567"; //Datos de la barberia
    static String direcBarberia = "Del semaforo del Rigoberto Lopez Perez, 1C al sur, Costado Oeste";
    static Scanner sc = new Scanner(System.in);
    static int edadCliente, numCortesCliente = 0; //Variables globales 
    static ArrayList<Cliente> listaClientes = new ArrayList<>();
    static ArrayList<Barbero> listaBarberos = new ArrayList<>(); //lista de los clientes,barberos y lista de cortes
    static ArrayList<Corte> listaCortes = new ArrayList<>();
    static String fechaCorte, nomCliente;
    static double gananciaDia;
    static LocalDate hoy = LocalDate.now(); //fecha en donde se aplico el corte el pelo
    ...
    public static void main(String[] args) {
        ...
        boolean continuar = true; //condicion repetitiva
        while (continuar) { 
            System.out.println("\n<----------Menu---------->");//menu del sistema
            ...
            switch (opt) { //opciones en cual deben seleccionarse
                case 1:
                    RegistrarCorte();
                    break;
                case 2:
    ...
    private static void verificarYCrearArchivo(String nombreArchivo) {
        File archivo = new File(nombreArchivo); //verifica el archivo si existe
        if (!archivo.exists()) {
            try {
    ...
    private static void inicializarBarberos() { //lista de los barberos
        ...
        for (Barbero barbero : listaBarberos) {
            EscribirBarbero(barbero); //escribe el barbero en cual este en la lista
        }
    }

    public static void RegistrarCorte() { //Registra los cortes segun el cliente
    ...
    public static void MostrarRegistro() { //suma los cortes al registro 
    ...
    public static double SumarVentas() { //suman las ventas de los cortes totales
        gananciaDia = 0;
        for (Corte cort : listaCortes) {
    ...
    public static void mostrarSalarios() {  //se muestra salario
        for (Barbero barbero : listaBarberos) {
            barbero.mostrarInformacion();
        }
    }

    public static void EscribirRegistro(Corte corte) { //escribe el registro en los archivos
    ...
    public static void LeerRegistro() { //evalua el registro 
    ...
    public static void EscribirCliente(Cliente cliente) { //escribe el cliente
    ...
    public static void LeerCliente() { //evalua el nombre del cliente
